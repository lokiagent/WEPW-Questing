...
def process_json(json_path):
    ...
    target_names = [f'"{name.strip()}"' for name in data['CombatWhiteList'].split(',') if name.strip()]
    waypoints_str = ',\n    '.join(waypoints)
    ...
    lua = (
        ...
        "}\n\n"
        "SetFoodAndDrink()\n"
        f"GrindAndGatherPath(TableToStringList(TargetNames), TableToVecList(Waypoints), {data['CombatRadius']}, {autoskin}, \"Override\")\n"
        "SetVendor()\n"
        "SellAtVendor()\n"
    )
