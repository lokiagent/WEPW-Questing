...
AcceptQuestUsingDB(2623);
TurnInQuestUsingDB(1444);
---- Obj Debug ---- .complete 2623,1
CompleteObjectiveOfQuest(2623,1);
TurnInQuestUsingDB(2623);
AcceptQuestUsingDB(2801);
---- Obj Debug ---- .complete 2801,1
CompleteObjectiveOfQuest(2801,1);
TurnInQuestUsingDB(2801);
AcceptQuestUsingDB(2581);
AcceptQuestUsingDB(2583);
AcceptQuestUsingDB(2585);
AcceptQuestUsingDB(2601);
AcceptQuestUsingDB(2603);
AcceptQuestUsingDB(3501);
