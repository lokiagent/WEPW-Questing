...
local TargetNames = {
    "Fel Iron Deposit", "Adamantite Deposit", "Rich Adamantite Deposit", "Khorium Vein", "Felweed", "Dreaming Glory"
}

SetFoodAndDrink()
GrindAndGatherPath(TableToStringList(TargetNames), TableToVecList(Waypoints), 2, false, "Override")
SetVendor()
SellAtVendor()
