...
local Waypoints = {
    {-236.527557,-4337.705,64.05991},
    {-198.5809,-4278.52832,66.7692261},
    {-225.757416,-4418.71729,63.03674}
}
...
SetFoodAndDrink()
GrindAndGatherPath(TableToStringList(TargetNames), TableToVecList(Waypoints), 1000, false, "Override")
SetVendor()
SellAtVendor()
