...
local Waypoints = {
    {-8760.097,-128.642792,83.24798},
    {-8773.336,-162.474442,82.07705}
}

local TargetNames = {
    "Kobold Vermin", "Kobold Worker"
}

SetFoodAndDrink()
GrindAndGatherPath(TableToStringList(TargetNames), TableToVecList(Waypoints), 59, false, "Override")
SetVendor()
SellAtVendor()
