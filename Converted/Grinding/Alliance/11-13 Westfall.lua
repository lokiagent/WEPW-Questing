...
local Waypoints = {
    {-10242.2109,949.7382,38.41812},
    {-10058.1436,927.0192,33.89464},
    {-9910.43,852.0331,30.0173512},
    {-9732.114,948.6029,31.0552082}
}

local TargetNames = {
    "Young Fleshripper", "Coyote Packleader", "Coyote", "Harvest Golem", "Young Goretusk", "Rusty Harvest Golem"
}
